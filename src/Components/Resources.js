...
function Resources() {
  return (
    <div className="Resources">
      ...
      <p className='res-desc'>All my resources (CV, Certifications) are available in the following <a href='https://github.com/joeperpetua/joeperpetua.github.io/tree/main/src/res' rel="noreferrer" target="_blank">link</a>.</p>

...
function About() {
  return (
    <div className="About">
      ...
      <p className='about-desc'>On my free time, I enjoy developing and working on my personal projects (currently <a href='#multilang'>MultiLang</a>). Lately I have been pretty obsessed with bouldering so I spend a lot of my free time in the gym.</p>

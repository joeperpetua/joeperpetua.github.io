...
function About() {
  return (
    <div className="About">
      ...
      <p className='about-desc'>Hi, I am Joel Perpetua. I am 22 years old and I was born and raised in Buenos Aires, Argentina.</p>
      <p className='about-desc'>I am currently based in Paris, France. Despite my development background I am working full time as a Backup & Sync Technical Support for Synology France. I enjoy developing and working on my personal projects in my free time.</p>
